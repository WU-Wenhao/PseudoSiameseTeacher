...
from ..parallel import collate as semi_collate
from .samplers import BalanceSampler
...
def build_dataloader(dataset,
    ...
    if runner_type == 'IterBasedRunner':
        ...
        if balance_sampler:
            # BalanceSampler can only be adopted on ConcatDataset
            sampler = BalanceSampler(dataset, samples_per_gpu)
        elif class_aware_sampler is not None:
    ...
    data_loader = DataLoader(
        ...
        collate_fn=partial(collate if not custom_collate else semi_collate, samples_per_gpu=samples_per_gpu),
